...
- `seed/seed_demo_course.sql` – inserts a demo tenant, user, and published **FSE-101** course with localised content.
- `functions/api` – Deno edge function that exposes aggregated course listings and quiz grading logic.
